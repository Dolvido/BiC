...
class VerifiedTutorAuthorTests(unittest.TestCase):
    work = dict(author_invocations=0, mock_api_calls=0, mock_metadata_calls=0,
                ...
                generated_lessons=0, learner_models=0, optimizer_updates=0)
    ...
    def setUp(self):
        ...
        transport = mock.patch.object(author.transport, "_request_json", side_effect=AssertionError("unmocked transport forbidden"))
    ...
    def test_invalid_and_injected_recipes_fall_back_with_original_response(self):
        ...
        for i,content in enumerate((json.dumps(bad),json.dumps(unknown),'{"schema":"x","schema":"y","chapters":[]}')):
    ...
    def test_parent_development_source_and_contract_rejected_before_intent(self):
        ...
        for case in ("audit","parent","source","slot","recipe","hash"):
            ...
            elif case=="source":request["source_sha256"]["experiments/verified_tutor_author.py"]="0"*64
    ...
    def test_local_digest_required_before_and_after_and_no_source_drift(self):
        ...
        changed=deepcopy(request["source_sha256"]);changed["experiments/verified_tutor_author.py"]="0"*64
